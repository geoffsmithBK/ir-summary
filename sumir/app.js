...
function readControls() {
    ...
    return {
        ...
        highpass: el('highpass').value === '' ? null : parseFloat(el('highpass').value),
        lowpass: el('lowpass').value === '' ? null : parseFloat(el('lowpass').value),
...
controls.addEventListener('change', rerun);
